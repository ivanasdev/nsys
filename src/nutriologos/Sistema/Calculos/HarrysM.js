...
const HarrysM = () => {
  ...
  const FaRef = useRef(1.2); // 1. Crear una referencia FaRef usando useRef
...
<div className="container-fluid">
 ...
 <div className="cardhomefirst"><h2 className="htitle">Calculo de Harrys Mujeres</h2></div> 
  <div className="row ">
      ...
      (
        ...
        <div className="texto cardharrys">
          ...
          <div className="cardhome">
           <p className="h3"> <h2>Metabolismo Basal: {metabolismo}</h2> </p>
           <p className="h3" >Calorias para mantener el peso: {gastoenergetico}</p>
           <div>
           <p className="h3" >Calorias para adelgazar:</p>
           <p className="h3">-300={gastoenergetico-300} </p>
           <p className="h3">-500={gastoenergetico - 500}</p>
           </div>

           <div>
           <p className="h3" >Calorias para subir :</p>
           <p className="h3">+500={gastoenergetico+500} </p>
           <p className="h3">+700={gastoenergetico + 700}</p>
           </div>
          </div>
